...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initPolaroidStack = () => {
        ...
        const media = [
            { type: 'image', src: 'assets/foto.jpeg', label: '🩷' },
            { type: 'image', src: 'assets/foto1.jpeg', label: '🩷' },
            { type: 'image', src: 'assets/foto2.jpeg', label: '🩷' },
            { type: 'image', src: 'assets/foto3.jpeg', label: '🩷' },
            { type: 'video', src: 'assets/video1.mp4', label: '🩷' },
            { type: 'video', src: 'assets/video2.mp4', label: '🩷' },
        ];
    ...
    // Dismiss popup on backdrop tap (clicking outside the card content)
